...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "狀態"),
        ("Your Desktop", "您的桌面"),
        ("desk_tip", "下方 ID 及密碼連線桌面"),
        ("Password", "密碼"),
        ("Ready", "已連線就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連線到 力新_立誠遠端伺服器..."),
        ("Enable service", "啟用服務"),
        ("Start service", "啟動服務"),
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "目前是免安裝模式。若要避開 UAC且常駐，請點選下方安裝按鈕將程式安裝到系統中。"),
        ...
        ("setup_server_tip", "你已成功連線到力新_立誠遠端伺服器"),
        ...
        ("About RustDesk", "力新_立誠RustDesk v1.4.12"),
