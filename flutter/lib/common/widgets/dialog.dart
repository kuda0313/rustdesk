...
// Ensure local address book exists when not logged in
  if (!gFFI.userModel.isLogin) {
    gFFI.abModel.ensureLocalAddressBook();
  }
  Future<bool> addTo(String abname) async {
    ...
    if (errMsg == null) {
      if (!gFFI.userModel.isLogin) {
        showToast(translate('Added to local address book'));
      } else {
  ...
  if (names.isEmpty) {
    BotToast.showText(text: translate("No writable address book"), contentColor: Colors.red);
    return;
  }
